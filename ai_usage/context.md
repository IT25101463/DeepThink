...
Corpus: The Ashen Era Archive (415 docs, 1277 pages in PDF, DOCX, MD, TXT, and Scans)
Core Architecture: Multimodal RAG with Modality-Aware Retrieval and Inline Figure Embedding
Rules:
- Strictly adhere to free-tier API hygiene (Voyage AI + OpenRouter).
...
### Iteration 1 (Sprint 1 Baseline - Naive):
```text
...
### Iteration 2 (Sprint 2 - Modality Aware):
```text
